...
export const mockCompany: Company = {
  ...
  slug: 'blue-wave-pool-service',
  email: 'info@bluewavepools.com',
  phone: '(313) 555-7665',
  address: '24680 Woodward Ave',
  city: 'Ferndale',
  state: 'MI',
  zip_code: '48220',
  service_area: {
    cities: ['Detroit', 'Ferndale', 'Royal Oak', 'Birmingham', 'Bloomfield Hills', 'Troy', 'Sterling Heights', 'Warren', 'Grosse Pointe'],
    radius_miles: 25,
    center_lat: 42.4611,
    center_lng: -83.1150,
  },
