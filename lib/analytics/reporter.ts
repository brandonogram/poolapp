...
<head>
  ...
  <title>PoolApp Weekly Performance Report</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>This report was automatically generated by PoolApp Analytics</p>
  ...
  async sendEmailDigest(report: WeeklyReport, config: EmailConfig): Promise<boolean> {
    ...
    const subject = config.subject || `PoolApp Weekly Report - ${report.periodEnd.toLocaleDateString()}`;
    ...
    const blocks: object[] = [
      {
        ...
        text: {
          type: 'plain_text',
          text: 'PoolApp Weekly Performance Report',
          emoji: true,
        },
      },
      {
  ...
  async sendSlackWebhook(report: WeeklyReport, config: SlackConfig): Promise<boolean> {
    ...
    const payload = {
      username: config.username || 'PoolApp Analytics',
  ...
  generateMarkdownReport(report: WeeklyReport): string {
    ...
    let md = `# PoolApp Weekly Performance Report
...
*This report was automatically generated by PoolApp Analytics*
`;
